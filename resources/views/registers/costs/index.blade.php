						...
						style="width:100%" id="employees-table">
					 	...
					 	<tbody>
					 		<tr>
					 			<th>{{ $cost->id }}</th>
					 			<th>{{ $cost->name }}</th>
					 			<th>R$ {{ number_format($cost->price, 2, ',','.') }}</th>
					 		<td>
					 				{{ Form::open(array('route' => array('costs.destroy', $cost->id), 'method' => 'delete')) }}
	  	...
	  	<div class="modal-dialog" role="document">
	    	<div class="modal-content">
		      	<div class="modal-header">
		        	...
		        	<h4 class="modal-title" id="myModalLabel">Cadastro de Despesas</h4>
		      	</div>
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  	<div class="modal-dialog" role="document">
	    	<div class="modal-content">
	      		...
	      		<div class="modal-body">
					<form action="{{ route('costs.update','test')}}" method="post">
					{{method_field('patch')}}
					{{csrf_field()}}	  
					<hr />	  
